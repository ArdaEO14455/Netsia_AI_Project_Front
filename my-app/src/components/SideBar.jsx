...
{/* Dropdown - Delete Icon */}
    <li class="dropdown-item h-100" onClick={async () => handleDelete(conversation._id)}>

      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="dropdown-icon bi bi-trash" viewBox="0 0 16 16" background="transparent">
