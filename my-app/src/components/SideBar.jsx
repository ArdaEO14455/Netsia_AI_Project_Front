  ...
  return (
    <div className="offcanvas offcanvas-start" 
      ...
      <div className="offcanvas-header">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="dropdown-icon bi bi-pencil-square" viewBox="0 0 16 16" onClick={newConversation}>
              ...
              <div className="conversation-content" >
                ...
                <div className="dropdown-container">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    >
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="dropdown-icon bi bi-pencil" viewBox="0 0 16 16">
